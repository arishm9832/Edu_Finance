    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex gap-2">
          ...
          >
            <SelectTrigger className="w-[130px] bg-slate-900 border border-white/20 hover:border-blue-400 text-white">
          ...
          >
            <SelectTrigger className="w-[130px] bg-slate-900 border border-white/20 hover:border-indigo-400 text-white">
